...
def main():
    ...
    lines = [
        ...
        "",
        "- **Термины.** «жаттықтырғыш», «жалғау», «нейрожелі», «қосымша» — те ли слова,",
        "  которые приняты в школьном учебнике и в обычной речи?",
        ...
        "",
        "## Места, в которых сомневается сам автор перевода",
        "",
        "Здесь перевод делал ассистент и уверенности в формулировке нет — посмотрите",
        "их отдельно, даже если остальное покажется приемлемым.",
        "",
        "| Ключ | Что смущает |",
        "|---|---|",
        "| `s02_lede` | «Жеткізе екен» — разговорная форма. Не должно ли быть «Жеткізеді екен»? |",
        "| `s03_left` | «Тіл көлеммен емес, қайталаумен беріледі» — подходит ли «беріледі», "
        "или уместнее «меңгеріледі»? |",
        "| `s08_next` | «Орыс тілін оқитын мектептерге нұсқа» — в русской версии сказано "
        "«для казахских школ, изучающих русский». Слово «қазақ» выпало ради длины строки: "
        "вернуть его или так тоже понятно? |",
        "| `s05_left` | Названия сервисов (GitHub, Vercel, Capacitor) оставлены латиницей "
        "и не склоняются. Так принято? |",
        "",
