...
EXPECTED = [
    ...
    ("s01_kpi[3]", "доля таких ответов"),
    ("s06_kpi[0]", "ответов с особыми буквами"),
    ("s06_kpi[1]", "доля таких ответов"),
    ("s11_kpi[2]", "слов в словаре"),
    ("s12_rows[0][2]", "уроков на уровне 1"),
    ("s12_rows[1][2]", "уроков на уровне 2"),
    ("s12_rows[2][2]", "уроков на уровне 3"),
    ("s15_kpi[0]", "вес в сжатом виде, КБ"),
    ("s15_kpi[2]", "фраз озвучки"),
]
