...
const KZ = {
  ...
  intro: '«Тіл» — тіл, «ашар» — ашады. Айша мен мұғалім әр тақырыпты үш қадаммен түсіндіреді.',
...
const RU: typeof KZ = {
  ...
  intro: '«Тіл» — язык, «ашар» — откроет. Айша и учитель объясняют каждую тему в три шага.',
