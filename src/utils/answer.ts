 ...
 * агглютинативен, и грамматика живёт в окончаниях. Одна буква — это уже
 * другое лицо: «оқимын» — «я читаю», «оқисың» — «ты читаешь», а разница
 * между ними в одном символе. Более щедрый допуск означал бы, что
 * приложение хвалит за перепутанную форму.
 *
...
export function checkAnswerDetailed(userAnswer: string, correct: string): CheckResult {
   ...
   *
   * Различие принципиальное. «оқимн» вместо «оқимын» — палец не дожал
   * клавишу. «оқисың» вместо «оқимын» — «ты читаешь» вместо «я читаю»,
