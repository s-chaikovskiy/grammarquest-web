  ...
  return (
    <div className="stack">
      <header className="stack--tight">
        ...
        {/* Что это за раздел, сказано прямо. Снаружи он выглядел как набор
            отдельных игр, хотя ничего нового здесь нет: те же задания
            из уроков, только возвращённые в нужный момент. */}
        <p className="t-small">
          Здесь нет новых заданий — это те же задания из уроков.
          Приложение возвращает их тогда, когда правило начинает забываться.
        </p>
      </header>
      ...
      <section className="stack--tight">
        ...
        <PracticeCard
          ...
          hint="Слова из пройденных уроков: увидел — вспомнил перевод"
          onClick={() => go('/cards')}
        />
